...
import (
	"context"
	"dagger/module-b/internal/dagger"
	"encoding/json"
	"fmt"
	"os"
)
...
type ModuleAID = dagger.ModuleAID
...
type ModuleA = dagger.ModuleA

type WithModuleAFunc = dagger.WithModuleAFunc
...
func (r ModuleB) MarshalJSON() ([]byte, error) {
	var concrete struct{}
	return json.Marshal(&concrete)
}

func (r *ModuleB) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "ModuleB":
		...
		case "MyFunction":
			...
			return (*ModuleB).MyFunction(&parent), nil
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("ModuleB").
					WithFunction(
						dag.Function("MyFunction",
