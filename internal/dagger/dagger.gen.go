...
import (
	...
	"dagger/module-b/internal/querybuilder"
)
...
// The `ModuleAID` scalar type represents an identifier for an object of type ModuleA.
type ModuleAID string
...
type WithModuleAFunc func(r *ModuleA) *ModuleA

// With calls the provided function with current ModuleA.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *ModuleA) With(f WithModuleAFunc) *ModuleA {
	return f(r)
}

func (r *ModuleA) WithGraphQLQuery(q *querybuilder.Selection) *ModuleA {
	return &ModuleA{
		query: q,
	}
}

// A unique identifier for this ModuleA.
func (r *ModuleA) ID(ctx context.Context) (ModuleAID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response ModuleAID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *ModuleA) XXX_GraphQLType() string {
	return "ModuleA"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *ModuleA) XXX_GraphQLIDType() string {
	return "ModuleAID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *ModuleA) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *ModuleA) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *ModuleA) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadModuleAFromID(ModuleAID(id))
	return nil
}

func (r *ModuleA) Message(ctx context.Context) (string, error) {
	if r.message != nil {
...
func (r *ModuleA) WithGreeting(greeting string) *ModuleA {
	q := r.query.Select("withGreeting")
...
func (r *ModuleA) WithName(name string) *ModuleA {
...
// Load a ModuleA from its ID.
func (r *Client) LoadModuleAFromID(id ModuleAID) *ModuleA {
	q := r.query.Select("loadModuleAFromID")
	q = q.Arg("id", id)
...
func (r *Client) ModuleA(greeting string, name string) *ModuleA {
	q := r.query.Select("moduleA")
	q = q.Arg("greeting", greeting)
	q = q.Arg("name", name)
